...
End-to-end data analysis project using **Python → MySQL → Power BI**  
...
- Only **27%** of customers are subscribers → huge loyalty opportunity  
- **Free & Standard Shipping** dominate → price-sensitive customers  
